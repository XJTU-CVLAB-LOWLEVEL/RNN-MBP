...
class Parameter:
    ...
    def extract_args(self):
        ...
        self.parser.add_argument('--num_gpus', type=int, default=2, help='# of GPUs to use')
        ...
        # data parameters
        self.parser.add_argument('--data_root', type=str, default='/home/zhuchao/dataset/', help='the path of dataset')
        self.parser.add_argument('--dataset', type=str, default='rbvd_lmdb', help='BSD, gopro_ds_lmdb, reds_lmdb, rbvd_lmdb')
        ...
        # model parameters
        self.parser.add_argument('--model', type=str, default='RNN-MBP', help='type of model to construct')
        self.parser.add_argument('--n_features', type=int, default=90, help='base # of channels for Conv')
